...
const riseDelays = [0, 120, 260, 420, 580]
    ...
    <section id="top" className="pt-40 pb-16 sm:pt-52 sm:pb-24">
      <div className="shell">
        <p
          ...
          style={{ animationDelay: `${riseDelays[0]}ms` }}
        >
          <span className="inline-block h-1.5 w-1.5 rounded-full bg-accent" />
          Lahore, Pakistan — Open to internships &amp; junior roles
        </p>
        <h1 className="animate-rise max-w-4xl text-display" style={{ animationDelay: `${riseDelays[1]}ms` }}>
        ...
        <p
          className="animate-rise mt-8 max-w-xl text-lede text-soft"
          style={{ animationDelay: `${riseDelays[2]}ms` }}
        >
        ...
        <div
          ...
          style={{ animationDelay: `${riseDelays[3]}ms` }}
        >
        ...
        <p
          ...
          style={{ animationDelay: `${riseDelays[4]}ms` }}
        >
